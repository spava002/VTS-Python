...
3. Click the **Settings (gear icon)** ![Settings Icon](https://postimg.cc/CnFTvdxY).
4. Ensure you are in the **General Settings** ![General Settings](https://postimg.cc/kD9mMYFZ).
5. Scroll down on the **right-side menu** until you find the **API Connection** option.
6. Turn on the **API Connection** ![API Connection](https://postimg.cc/9zpjDPLf).
...
1. Run the script:
   ...
   python vts_api.py
   ```
2. The script will make an **authentication request**, which you must **approve within VTube Studio** ![Authentication Request](https://postimg.cc/PP5nYL7Q).
3. After approval:
